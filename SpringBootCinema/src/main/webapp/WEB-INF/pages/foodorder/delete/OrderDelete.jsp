...
<body>
	...
	<div class="container">
		<h2>刪除食物訂單</h2>
		<form action="deleteFoodOrders" method="post" >
			<div class="row">
				<div class="col-25">
					<label  for="order_No">訂單編號(order_No):</label>
				</div>
				<div class="col-75">
					<input  type="text" id="foodorder_No" name="foodorder_No" placeholder=""/>
				</div>
			</div>
			...
			<div class="row">
				...
				<button type= "submit"  name ="read" value="刪除訂單">刪除食物訂單 </button> 
			</div>
		</form>
	</div>
