...
<body>
	...
	<div class="container">
		<h2>修改訂單</h2>
		<form:form action="updateOrderwithno" method="post" modelAttribute="Order">
<!-- 			<div class="row"> -->
<!-- 				<div class="col-25"> -->
<%-- 					<form:label  path="order_No" for="order_NO">訂單編號(Order_No):</form:label> --%>
<!-- 				</div> -->
<!-- 				<div class="col-75"> -->
<%-- 					<form:input path="order_No" type="text" id="order_NO" name="order_NO" placeholder=""  hidden/> --%>
<!-- 				</div> -->
<!-- 			</div> -->
			<div class="row">
				<div class="col-25">
			...
			<br>
			<div class="row">
				<form:button value="Send">修改訂單</form:button>
			</div>
		</form:form>
	</div>
