...
<body>
	...
	<%
	Order od = (Order) session.getAttribute("delete_Info");
	out.write("<br>");
	out.write("訂單刪除成功，刪除訂單資訊如下:");
	out.write("<br>");
	out.write("<br>");
	...
	out.write("</td><td>" + od.getAccount() + "</td><td>" + od.getMovie() + "</td><td>" + od.getSeat() + "</td><td>"
			+ od.getDate() + "</td><td>" + od.getShowing() + "</td><td>" + od.getUnit_Price() + "</td><td>" + od.getNumber()
			+ "</td><td>" + od.getPhone() + "</td><td>" + od.getOrder_No() + "</td>");
