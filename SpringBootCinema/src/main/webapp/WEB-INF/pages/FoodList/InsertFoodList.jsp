...
<div class="container2">		
		<form action="addFood.controller" method="post" enctype="multipart/form-data">
			<div class="row">
				<div class="col-25">
					<label for="food">品項</label>
				</div>
				<div class="col-75">
					<input type="text" id="food" name="food" placeholder="">
				</div>
			</div>
			<div class="row">
				<div class="col-25">
			...
			<br>
			<div class="row" id="b">
				<input type="submit" name="submit" value="新增品項">
			</div>
		</form>
...
<div class="text">首頁->商品管理->新增菜單</div>	
</form>		
</body>
</html>